...
extern void			sffi_func_call			(const sffi_func_t func, void* rvalue, void**	avalue);
#ifdef LIBFFI_H
...
extern sffi_error_t	sffi_adapter_call		(const	sffi_adapter_t	adapter, const sffi_func_t			func,					void* rvalue,		uint_t argc,			void**	argv);
